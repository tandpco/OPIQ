...
var text = req.body.html;
	...
	// text += ".section .header:not(:first-child) .icon{padding-bottom:6px !important;}";
	// text += ".section .header:first-child .icon{padding-top:5px !important;}";
