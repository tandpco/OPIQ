...
var text = req.body.html;
	...
	text += ".section:not(:first-child) .header .icon{padding-bottom:5px !important;}";
	...
	text += ".print .inner-content .body .t{height:auto !important;}";
	...
	text += ".section>.body{padding-left:50px !important;margin-bottom:3px !important}";
