...
var text = req.body.html;
	...
	text += ".date {position: absolute; width: 100%; text-align: center; color: white; top: 725px !important; font-size: 17px; }";
	text += ".first-page .analysis-header{color:#6e6e6e !important;position:absolute;width:100%; font-family: museo !important;top:550px !important; }";
