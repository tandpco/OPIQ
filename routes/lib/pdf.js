...
var text = req.body.html;
	...
	text += ".section .header .icon{width:5% !important;padding-top:2px !important; padding-bottom:2px !important;}";
	text += ".section .header div:last-child{width:90% !important;}";
