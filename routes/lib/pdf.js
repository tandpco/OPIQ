...
var text = req.body.html;
	...
	text += ".section:not(:first-child) .header .icon{padding-bottom:6px !important;}";
	text += ".section:first-child .header .icon{padding-top:5px !important;}";
	text += ".section:not(:first-child) .body{font-size:10px !important;}";
