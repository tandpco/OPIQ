...
var text = req.body.html;
	...
	text += ".section *, .section>.body>.t *{font-size:9px !important;}";
	...
	text += ".date {position: absolute; width: 100%; text-align: center; color: white; top: 625px !important; font-size: 17px; }";
	text += ".first-page .analysis-header{color:#6e6e6e !important;position:absolute;width:100%; font-family: museo !important;top:500px !important; }";
