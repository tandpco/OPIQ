...
var text = req.body.html;
	...
	text += ".last-page .analysis-subtitle {font-size: 14px;}";
	text += ".last-page .link {font-weight: bold; font-size: 12px; color: #BCDA44;}";
	...
	text += ".last-page img{width:200px; height: auto;}";
	...
	text += ".analysis-subtitle{width: 100%;text-align: center;}";
